...
export class DebuggerTracker implements vscode.DebugAdapterTracker {
            ...
            case 'event': {
                ...
                if (ev) {
                    if (ev.event === 'stopped') {
                        ...
                        DebuggerTracker.setStatus(
                            this.session,
                            DebugSessionStatus.Stopped,
                            ev as DebugProtocol.StoppedEvent
                        );
                        return;
    ...
    private static setStatus(s: vscode.DebugSession, status: DebugSessionStatus, optArg?: DebugProtocol.StoppedEvent) {
